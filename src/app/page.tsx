       ...
       <div className=" relative z-10 w-full">
        <div className=" mx-auto max-w-7xl  px-6 lg:px-12">
          <div className=" max-w-3xl">
            ...
            <span className=" text-sm font-medium tracking-wide text-white">Premium Real Estate Marketplace</span>
            </div>

            {/* heading */}
              <h2 className=" text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">Find The Perfect Place To Call Home</h2>

              <p className=" mt-6 max-w-2xl text-lg leading-relaxed text-white/70 "> Discover luxury apartments, modern homes, and premium Properties 
              in the best locations around the world.  </p>
